    ...
    <header class="sticky top-0 z-50 bg-[#FFFDF7]/90 backdrop-blur-md border-b border-amber-100 shadow-sm">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center space-x-8 text-slate-600 font-semibold text-sm">
                ...
                <a href="#resep-populer" class="hover:text-amber-600 transition-colors py-1 border-b-2 border-transparent hover:border-amber-600">
                    Resep Populer
                </a>
            ...
            <div class="flex items-center gap-4">
                <div class="relative hidden lg:block">
                    <input type="text" placeholder="Cari resep makanan..." class="bg-slate-100 text-sm rounded-full pl-4 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500 w-60">
